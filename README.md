...
| `shaders/` | GLSL ES 3.00 for the spectral surface step (FFT pass, mode evolution, forces), the caustics and the pool render, and for the shallow-water flow step and the table render (what the site runs); an HLSL file for Unity and Unreal; a Godot 4 shader. |
